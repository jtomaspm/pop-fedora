...
configure_dash_to_dock() {
    ...
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-1 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-10 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-2 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-3 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-4 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-5 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-6 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-7 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-8 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-ctrl-hotkey-9 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-1 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-10 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-2 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-3 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-4 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-5 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-6 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-7 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-8 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-hotkey-9 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-1 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-10 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-2 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-3 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-4 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-5 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-6 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-7 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-8 "@as []"
    run_user gsettings set "$DASH_TO_DOCK_SCHEMA" app-shift-hotkey-9 "@as []"
